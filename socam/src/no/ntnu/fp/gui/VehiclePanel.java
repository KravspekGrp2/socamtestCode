...
public class VehiclePanel extends JPanel implements PropertyChangeListener, ActionListener, ItemListener, FocusListener {
	...
	public VehiclePanel(ProjectPanel ppanel) {
        ...
        serialTextField.addPropertyChangeListener(this);
        ...
        seriesTextField.addPropertyChangeListener(this);
        ...
        historyLogTextArea.addPropertyChangeListener(this);
    ...
    {
        if (evt.getSource() == serialTextField) {
            sourceChanged(serialTextField);
