    ...
    implements PropertyChangeListener, ActionListener, ItemListener, FocusListener
{
    ...
    public PersonPanel(ProjectPanel ppanel) {
        ...
        cityTextField.addPropertyChangeListener(this);
        ...
        streetTextField.addPropertyChangeListener(this);
    ...
    {
        if (evt.getSource() == streetTextField) {
            sourceChanged(streetTextField);
        ...
        } else if (evt.getSource() == cityTextField) {
        		sourceChanged(cityTextField);
        } else if (evt.getSource() == projectPanel.getVehiclePanel().getSerialTextField()) {
        		sourceChanged(projectPanel.getVehiclePanel().getSerialTextField());
        } else {
    ...
    private void sourceChanged(Object source) {
        ...
        if (source == nameTextField) {
            ...
            model.setStreet((String)streetTextField.getValue());
        } else if (source == cityTextField) {
            model.setCity((String)cityTextField.getValue());
        } else if (source == projectPanel.getVehiclePanel().getSerialTextField()) {
            model.setVehicleID(projectPanel.getVehiclePanel().getSerialTextField().getText());
        }
